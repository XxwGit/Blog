...
public class TestOrg {
	...
	public String toString() {
		return "TestOrg [o=" + o + ", parentId=" + parentId + ", orgName=" + orgName + ", orgCode=" + orgCode
				+ ", orgType=" + orgType + ", startDate=" + startDate + ", endDate=" + endDate + ", attribute="
				+ attribute + ", insertTime=" + insertTime + "]";
	}
